...
public:
    ...
    const char *metaData(int64_t index) const;
...
template<typename Key, typename Value>
const char *Data<Key, Value>::metaData(int64_t index) const
{
...
{
    mMetaData.insert(mMetaData.begin() + index, values.cbegin(), values.cend());
}
